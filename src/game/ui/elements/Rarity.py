from src.game.entities.items.config.RARITY_CONFIG import RARITY_DISPLAY_CONFIG
...
class Rarity:
    def __init__(self, rarity_value):
        ...
        # data
        self.tag = RARITY_DISPLAY_CONFIG[rarity_value]['tag']
        self.name = RARITY_DISPLAY_CONFIG[rarity_value]['name']

        # color
        self.primary_color_rgb = RARITY_DISPLAY_CONFIG[rarity_value]['primary_color']
        self.secondary_color_rgb = RARITY_DISPLAY_CONFIG[rarity_value]['secondary_color']
